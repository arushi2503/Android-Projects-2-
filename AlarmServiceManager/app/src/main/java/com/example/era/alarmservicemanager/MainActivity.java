package com.example.era.alarmservicemanager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        elapsedWakeUp = findViewById(R.id.button);
        rtcWakeup = findViewById(R.id.button2);
        cancelAlarm = findViewById(R.id.button3);
